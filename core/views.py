...
def download_residence_pdf(request, pk):
    ...
    label_style = ParagraphStyle('Label', parent=styles['Normal'], fontSize=9, textColor=colors.HexColor('#5EAFA8'), spaceAfter=2)
    elements = []
    ...
    if residence.security_guard: amenities.append('🛡️ Security Guard')
